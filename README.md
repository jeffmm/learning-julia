...
```bash
$ make bash
$ python learning_julia/scripts/etl.py configs/examples/config_example.yml
```
...
```bash
python learning_julia/scripts/evaluate.py configs/examples/config_example.yml
```
...
└── learning_julia    <- Project source directory
